...
Plugin URI: http://wordpress.org/extend/plugins/wp-content-protector/
Description: THIS PLUGIN IS NOW NO MORE SUPPORTED BY THE AUTHER, SO IT IS HIGHLY RECOMMANDED TO USE <a href="http://wordpress.org/extend/plugins/wp-copyprotect/">WP-COPYPROTECT</a> INSTEAD.
Version: 1.9
Author: Anurag
Author URI: http://wordpress.org/extend/plugins/wp-content-protector/
*/
...
function CopyProtect_options_page()
{
	if($_POST['CopyProtect_save']){
		...
		echo '<div class="updated"><p>Commands NOT accepted, Plugin will not work at all, please uninstall it.</p></div>';
	}
	...
	<form method="post" id="CopyProtect_options">
		...
		<H2>PLEASE NOTE THAT THIS PLUGIN IS NOW NO MORE SUPPORTED BY THE AUTHER, SO IT IS HIGHLY RECOMMANDED TO USE <a href="http://wordpress.org/extend/plugins/wp-copyprotect/">WP-COPYPROTECT</a> INSTEAD.</h2>
		<h3>Please deactivate this plugin and delete it to install the <a href="http://wordpress.org/extend/plugins/wp-copyprotect/">WP-COPYPROTECT</a></h3>
		<h3><a href="/wp-admin/plugin-install.php?tab=search&type=tag&s=copyprotect">Click here to install WP-CopyProtect</a></h3>
		<br /><br />
...
Most copy cats use your blogs <a href="/feed/" target="_blank">RSS feeds</a> to steal the content. Always select "Summary" at "For each article in a feed, show" in Wordpress admin panel "<a href="options-reading.php">Reading Settings</a>" so that even if someone try to copy your content from feeds he/she can not copy the whole post.
		...
		<h3>Thank you</h3>
		ORIGIONAL Plug in developed by <a href="http://www.thechetan.com/" target="_blank">Chetan Gole</a>.
		</fieldset>
	</form>
	</table>
	</div>
...
function CopyProtect_adminmenu()
{
	if (function_exists('add_options_page')) {	
		add_options_page('WP-Content Protector', 'WP-Content Protector', 9, basename(__FILE__),'CopyProtect_options_page');
	}
}

function plugin_notice( $plugin ) {
if( $plugin == 'wp-content-protector/wp-content-protector.php' )
   echo '<tr class="plugin-update-tr"><td colspan="3" class="plugin-update"><div class="update-message"><a href="/options-general.php?page=wp-content-protector.php">WP-Content Protector</a> plugin is no more supported by the auther, please uninstall it and use <a href="http://wordpress.org/extend/plugins/wp-copyprotect/">WP-CopyProtect</a>.</div></td></tr>';
}
...
function admin_notice() {
		...
		echo '<center><a href="/wp-admin/options-general.php?page=wp-content-protector.php">WP-Content Protector</a> plugin is no more supported by the auther, please uninstall it and use <a href="http://wordpress.org/extend/plugins/wp-copyprotect/" target="_blank">WP-CopyProtect</a></center>';
}
